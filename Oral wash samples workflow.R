...
##Figure S10 The comparison between the oral wash samples and sputum samples bacterial DNA burden  
...
#Figure S11a PCoA plot based on unweighted UniFrac distance between sputum samples and negative control samples.
...
#Figure S11b PCoA plot based on weighted UniFrac distance between sputum samples and negative control samples.
#PERMANOVA between sputum samples and negative control samples.
...
#Figure S11c Top 15 ZOTUs are ranked in descending order of mean relative abundance of oral wash samples.
...
#Figure S11d  Top 15 ZOTUs are ranked in descending order of mean relative abundance of control samples.
...
#Figure S11e-f Decontam package confirms contaminants ZOTUs in our data using both the frequency and prevalence methods with threshold 0.1 and 0.5 respectively.
...
##Figure S12 Similar but not identical microbial profile between oral cavity and airway microbiota  
